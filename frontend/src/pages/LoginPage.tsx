    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Staff & administrator portal</p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 pt-4 border-t border-border">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <p><strong>Admin:</strong> admin@bonfire.org / admin123</p>
                <p><strong>Staff:</strong> staff@bonfire.org / staff123</p>
                <p><strong>Director:</strong> director@bonfire.org / director123</p>
              </div>
            </div>
          </CardContent>
        </Card>
